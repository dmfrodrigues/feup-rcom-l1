 ...
 * @ingroup     ll
 * @brief       Logical link (LL) state machine that allows to receive U-frames; for internal use.
 */
 ...
 */
int ll_u_state_update(ll_u_statemachine_t *machine, uint8_t byte) __attribute__((warn_unused_result));
