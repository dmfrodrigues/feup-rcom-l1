...
In order to validate the functionality of the protocols, the application was tested with a variety of files, distinguishing in type and size. Furthermore, was introduced errors to check the robustness of the program.
