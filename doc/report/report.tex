...
\begin{table}[H]
	...
	\begin{tabular}{l | p{12cm}}
		...
		\texttt{verbosity}       & Verbosity accepted for printing. The program can be compiled in debug or release mode; in debug mode, logs will be printed, if they are less or as verbose as a certain verbosity level, according to the value in this field.\\ \hline \hline
	\end{tabular}
