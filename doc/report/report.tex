	...
	\begin{subfigure}[t]{0.31\textwidth}
		...
		\begin{tikzpicture}[baseline]
			...
			\begin{axis}[
				...
				grid=major,
				grid style={dashed,black!50},
				xmin=0, xmax=260, xtick distance=50, xlabel=Number of frames $N$, x tick label style={rotate=90},
				ymin=0, ymax=0.8, ytick distance=0.1, yticklabels={,,}
			]
				\addplot[only marks, blue, mark=*, mark options={mark size=1.5pt}] table[x=N,y=S,col sep=comma] {vary-size.csv};
				\addplot[mark=none, black, domain=-100:300] {-0.00090564*x+0.77701351} node[right, align=left] at (10, 0.45) {$y=-0.00090564x+0.77701351$\\$r^2=0.991153$};
			\end{axis}
		\end{tikzpicture}
	\end{subfigure}
