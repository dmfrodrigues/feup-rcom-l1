...
\begin{figure}[H]
	...
	\begin{tabular}{m{6mm} m{108mm}}
		...
		\begin{tikzpicture}[->,>=stealth',node distance=2cm,initial text=$ $,]
			...
			\node[align=center, draw, minimum width=1.2cm, minimum height=1.2cm] at (4.8, 0) (d1) {$\text{D}_1$};
...
\begin{figure}[H]
	...
	\begin{tabular}{m{6mm} m{108mm}}
		...
		\begin{tikzpicture}[->,>=stealth',node distance=2cm,initial text=$ $,]
			...
			\node[align=center, draw, minimum width=1.2cm, minimum height=1.2cm] at (4.8, 0) (p1) {$\text{P}_1$};
			\node[align=center, dashed, draw, minimum width=2.4cm, minimum height=1.2cm] at (6.6, 0) (packets) {...};
			\node[align=center, draw, minimum width=1.2cm, minimum height=1.2cm] at (8.4, 0) (pk) {$\text{P}_\text{k}$};
